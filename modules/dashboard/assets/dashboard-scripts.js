...
// Inject SweetAlert fade styles once
function injectSwalFadeStylesOnce() {
  if (typeof document === 'undefined') return;
  if (document.getElementById('swal-fade-styles')) return;
  const styleEl = document.createElement('style');
  styleEl.id = 'swal-fade-styles';
  styleEl.textContent = `
    /* Enhanced SweetAlert2 Animation Styles */
    .swal2-popup-custom {
    ...
    .swal2-animate-show { animation: swalFadeIn 0.25s ease-out both; }
    .swal2-animate-hide { animation: swalFadeOut 0.2s ease-in both; }
  `;
